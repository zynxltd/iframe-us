<template>
    <div class="mb-6">
        <label class="block text-sm font-semibold text-neutral-800 mb-2 uppercase tracking-wide">House Name or Number</label>
        <input
            v-model="model"
            type="text"
...
const validateHouseNameNumber = () => {
    ...
    // Regex for valid house number or name
    const regex = /^[a-zA-Z0-9\s\-]+$/

    if (!houseNameOrNumber.match(regex)) {
