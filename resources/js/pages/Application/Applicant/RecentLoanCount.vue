<template>
    <div class="mb-6">
        <label class="block text-sm font-semibold text-neutral-800 mb-2 uppercase tracking-wide">Recent Loan Count</label>
        <div class="flex gap-3 w-full">
            <label
                ...
                class="flex items-center justify-center text-center text-xs font-medium  h-14 w-full px-2 py-3 rounded-xl cursor-pointer border-2 transition-all duration-300"
                    ...
                    : 'bg-[#fff] border-cyan-500 text-black hover:bg-cyan-600 hover:text-white hover:border-purple-400'"
            >
                <input
                    type="radio"
                    :value="option.value"
